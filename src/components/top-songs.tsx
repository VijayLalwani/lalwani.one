...
import bigDawgsCover from "@/assets/images/music/big-dawgs.jpg";
import maryJaneCover from "@/assets/images/music/mary-jane.jpg";
import oneLoveCover from "@/assets/images/music/one-love.jpg";
import boyzNTheHoodCover from "@/assets/images/music/boyz-n-the-hood.jpg";
import laKiffanceCover from "@/assets/images/music/la-kiffance.jpg";
import chequesCover from "@/assets/images/music/cheques.jpg";
  ...
  const songs = React.useMemo<Song[]>(
    () => [
      ...
      },
      {
        title: "Mary Jane",
        artist: "K.A.A.N",
        link: "https://open.spotify.com/track/2ExqahkLFfOnLKUebdewRq",
        imageUrl: maryJaneCover,
        background:
